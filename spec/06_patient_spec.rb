...
describe 'Patient' do
  ...
  describe '#appointments' do
    it 'returns all appointments associated with this Patient' do
      ...
      appointment = Appointment.new(steve, 'Friday, January 32nd', doctor_who)
      appointment_2 = Appointment.new(steve, 'Saturday, January 33rd', doctor_smith)
      appointment_3 = Appointment.new(mike, 'Sunday, January 34th', doctor_who)
